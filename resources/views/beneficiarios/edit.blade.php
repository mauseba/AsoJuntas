...
<x-app-layout>
    ...
    <div class=" flex flex-col items-center ">
        <div class="flex flex-col bg-green-700  px-4 sm:px-6 md:px-8 lg:px-10 py-8  w-full max-w-md ">
            ...
            <form method="POST" action="/beneficiarios/{{ $beneficiarios->id }}" enctype="multipart/form-data"> 
                ...
                <div class="mb-4">
                    ...
                    <div class="relative inline-block text-gray-700 mb-2">
                      <select name="tipo_doc"  class="my-select w-full h-10 pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline ">       
                ...
                <div class="mb-4">
                    ...
                    <input required name="numero" value="{{ $beneficiarios->numero }}" class=" h-10   pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline"  type="number" placeholder="Numero" size="20" maxlength="20"/>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input required name="edad" value="{{ $beneficiarios->edad }}" maxlength="2" class=" h-10 pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" type="number" placeholder="Edad" min="1"  max="99"/>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative inline-block text-gray-700">
                      <select name="tipo_salud" class="my-select w-full h-10 pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative inline-block text-gray-700">
                        <select name="salud" class="w-full h-10 pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
                          ...
                          <option @if ( $beneficiarios->salud  == $entidad->name) selected="selected" @endif>{{$entidad->name}}</option>
                          @endforeach  
                ...
                <div class="mb-4">
                    ...
                    <div class="relative inline-block text-gray-700">
                        <select name="nivel_edu" class=" my-select w-full h-10 pl-3 pr-6 text-xs placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
        ...
        <button type="submit" name="insertar" value="Insertar Alumno" class="bg-green-300 hover:bg-green-400 text-green-800 font-bold py-2 px-4 rounded inline-flex items-center">Actualizar</button>
        <a class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center" href="{{route('beneficiarios.index')}}">Volver</a>
