<nav class="bg-green-700" x-data="{ open: false }">
    <div class="static max-w-7xl mx-auto px-2 sm:px-6 md:px-6  lg:px-5">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start md:items-stretch md:justify-start">
        ...
        @auth
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0  md:static md:inset-auto md:ml-6 md:pr-0">
